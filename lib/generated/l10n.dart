...
class S {
  ...
  String get please_add_new_delivery_address {
    return Intl.message(
      'Please add new shipping address',
      name: 'please_add_new_delivery_address',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Your phone used to connect. Send a code to verify your phone Number, please check it's correct number`
  String get your_phone_used_to_connect {
    return Intl.message(
      'Your phone used to connect. Send a code to verify your phone Number, please check it\'s correct number',
      name: 'your_phone_used_to_connect',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Click to pay with Mada`
  String get click_to_pay_with_mada_method {
    return Intl.message(
      'Click to pay with Mada',
      name: 'click_to_pay_with_mada_method',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Sorry, your order less than `
  String get order_less_than {
    return Intl.message(
      'Sorry, your order less than ',
      name: 'order_less_than',
      desc: '',
      args: [],
    );
  }
  ...
  /// `FREE delivery when your order is `
  String get free_delivery_on {
    return Intl.message(
      'FREE delivery when your order is ',
      name: 'free_delivery_on',
      desc: '',
      args: [],
    );
  }
  ...
  /// `phone mustn't starts with zero`
  String get starts_with_zero {
    return Intl.message(
      'phone mustn\'t starts with zero',
  ...
  String get sms_sent_to_you {
    return Intl.message(
      'SMS has been sent to ',
      name: 'sms_sent_to_you',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Not a valid code`
  String get not_a_valid_code {
    return Intl.message(
      'Not a valid code',
      name: 'not_a_valid_code',
      desc: '',
      args: [],
    );
  }
  ...
  String get your_account_is_verified {
    return Intl.message(
      'Your account has been verified',
      name: 'your_account_is_verified',
      desc: '',
      args: [],
    );
  }
  ...
  String get product_refreshed_successfully {
    return Intl.message(
      'Product refreshed successfully',
      name: 'product_refreshed_successfully',
      desc: '',
      args: [],
    );
  }

  /// `Favorite refreshed successfully`
  String get favorite_refreshed_successfully {
    return Intl.message(
      'Favorite refreshed successfully',
      name: 'favorite_refreshed_successfully',
      desc: '',
      args: [],
    );
  }
  ...
  /// `No Orders`
  String get no_recent_orders {
    return Intl.message(
      'No Orders',
      name: 'no_recent_orders',
      desc: '',
      args: [],
    );
  }
  ...
  String get some_product_not_deliverable {
    return Intl.message(
      'Some products are not deliverable',
      name: 'some_product_not_deliverable',
      desc: '',
      args: [],
    );
  }
  ...
  String get how_would_you_rate_this_order {
    return Intl.message(
      'How would you rate this order?',
      name: 'how_would_you_rate_this_order',
      desc: '',
      args: [],
    );
  }
  ...
  /// `A new version of Dukkank is available PLEASE UPDATE`
  ...
  String get must_choose_an_option {
    return Intl.message(
      'Must choose an option',
      name: 'must_choose_an_option',
      desc: '',
      args: [],
    );
  }
