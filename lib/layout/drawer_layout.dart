...
import '../screens/manage_products/manage_products.dart';

drawer_layout(AuthController _controller, BuildContext context) {
        ...
        Expanded(
          child: ListView(
            children: [
              ...
              _listtileTitle("Products", context),
              ..._report_title.map(
                    (element) => Column(
                  children: [
                    if (_report_title.indexOf(element) == 1)
